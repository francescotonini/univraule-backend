...
const getLessons = async (month, year, academicYearId, courseId, courseYearId) => {
	...
	logger.debug(`getLessons(): found ${lessons['length']} lessons for academicYearId ${academicYearId}, courseId ${courseId}, courseYearId ${courseYearId}`);
...
const getWeeklyTimetable = async (firstDayOfWeek, academicYearId, courseId, courseYearId) => {
	...
	try {
		...
		logger.error(`getWeeklyTimetable(): exception on request for firstDayOfWeek ${firstDayOfWeek}, academicYearId ${academicYearId}, courseId ${courseId}, courseYearId ${courseYearId} - ${e['message']}`);
...
const getRooms = async (officeId) => {
	...
	try {
		...
		logger.error(`getRooms(): exception on request for officeId ${officeId} - ${e['message']}`);
